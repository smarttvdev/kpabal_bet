...
@section('css')
    ...
    <style>
        ...
        .select {
            background: url(../assets/images/br_down.png) no-repeat right #f7f7f7;
                                ...
                                <div class="login-admin login-admin1">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text"
                                                           ...
                                                           name="name" id="" value="{{ $user->name }}" required
                                                           placeholder="Name">
                                                    @if ($errors->has('name'))
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="col-md-12 white"><strong
                                                            style="text-transform: uppercase;">User
                                                        Name :</strong></label>
                                                <div class="col-md-12">
                                ...
                                <strong>{{ $errors->first('username') }}</strong>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 white">
                                            <div class="form-group">
                                                <label class="col-md-12"><strong style="text-transform: uppercase;">Phone
                                                        :</strong></label>
                                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="col-md-12 white"><strong
                                                            style="text-transform: uppercase;">City
                                                        :</strong></label>
                                                <div class="col-md-12">
                                        ...
                                        <div class="col-md-6 white">
                                            <div class="form-group">
                                                <label class="col-md-12"><strong style="text-transform: uppercase;">Zip
                                                        Code
                                                        :</strong></label>
                                                <div class="col-md-12">
                                ...
                                <strong>{{ $errors->first('zip_code') }}</strong>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <select name="country"
                                                            class="form-control select {{ $errors->has('country') ? ' is-invalid' : '' }}"
                                                            id="country">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 white">
                                            <div class="form-group">
                                                <label class="col-md-12"><strong style="text-transform: uppercase;">Address
                                                        :</strong></label>
                                                <div class="col-md-12">
                                            <textarea name="address" id="textareaAddress" rows="4"
                                                      class="{{ $errors->has('address') ? ' is-invalid' : '' }}"
                                                      style=""
                                                      placeholder="Street Address ">{{ $user->address}}</textarea>
                                                    <span class="invalid-feedback" style="color: red">
                    ...
                    <div class="row">
                        <div class="form-group">
                            <div class="col-md-9 col-md-offset-3">
                                <input type="submit" class="btn-block  btn btn-success" value="UPDATE PROFILE">
                            </div>
                        </div>
                    </div>
                    {!! Form::close() !!}
