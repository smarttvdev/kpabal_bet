                    ...
                    <form class="form-horizontal" action="{{ route('menu-update',$menu->id) }}" method="post" role="form">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-12">
                                    <input class="form-control input-lg" value="{{ $menu->name }}" name="name" placeholder="" type="text" required>
                                    @if ($errors->has('name'))
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <button type="submit" class="btn blue btn-block btn-lg"><i class="fa fa-send"></i> UPDATE MENU</button>
                                </div>
                            </div>
