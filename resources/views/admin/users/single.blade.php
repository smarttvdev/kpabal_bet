                                ...
                                <div class="portlet box purple">
                                    ...
                                    <div class="portlet-body">
                                        <div class="row">
                                            ...
                                            <!-- START -->
                                            <a href="{{route('user.trans',$user->id)}}">
                                                    ...
                                                    <div class="dashboard-stat blue">
                                                        ...
                                                        <div class="details">
                                                            <div class="number">
                                                                ...
                                                                @endphp
                                                                <span data-counter="counterup" data-value="{{$trans}}">{{$trans}}</span>
                                                            </div>
                                                        ...
                                                        <div class="more">
                                                            <div class="desc uppercase bold text-center">
                                                                {{$basic->currency}}
                                                                <span data-counter="counterup" data-value="{{$transAmount}}">{{$transAmount}}</span> TRANSACTED
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <!-- END -->
                                            <!-- START -->
                                            <a href="{{route('user.deposit',$user->id)}}">
                                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12" style="margin-bottom: 20px;">
                                                    <div class="dashboard-stat yellow">
                                                        ...
                                                        <div class="more">
                                                            <div class="desc uppercase bold text-center">
                                                                {{$basic->currency}}
                                                                <span data-counter="counterup" data-value="{{$depositAmount}}">{{$depositAmount}}</span> Deposited
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <!-- END -->
                                            <!-- START -->
                                            <a href="{{route('user.withdraw',$user->id)}}">
                                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12" style="margin-bottom: 10px;">
                                                    <div class="dashboard-stat red">
                                                        ...
                                                        <div class="details">
                                                            <div class="number">
                                                                <span data-counter="counterup" data-value="{{$withDraw}}">{{$withDraw}}</span>
                                                            </div>
                                                        ...
                                                        <div class="more">
                                                            <div class="desc uppercase bold text-center">
                                                                {{$basic->currency}}
                                                                <span data-counter="counterup" data-value="{{$withDrawAmount}}">{{$withDrawAmount}}</span> WITHDRAWN
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="row">
                                <div class="portlet box blue-ebonyclay">
                                    ...
                                    <div class="portlet-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <a href="{{route('user.balance',$user->id)}}" class="btn btn-lg btn-block btn-success" ><i class="fa fa-money"></i> Add/Substract Balance</a>
                                                <br>
                                            </div>
                                            <div class="col-md-6">
                                                <a href="{{route('user.login.history',$user->id)}}" class="btn btn-lg btn-block btn-success" ><i class="fa fa-sign-out"></i> Login History</a>
                                                <br>
                                            </div>

                                            <div class="col-md-6">
                                                <a href="{{route('user.email',$user->id)}}" class="btn btn-lg btn-block btn-primary" style="margin-bottom:10px;"> <i class="fa fa-envelope"></i> Send Email</a>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <form id="form" method="POST" action="{{route('user.status', $user->id)}}" enctype="multipart/form-data" name="editForm">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6 ">
                                                    <label> City</label>
                                                    <input type="text" name="city" class="form-control input-lg" value="{{$user->city}}">

                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label>Zip Code</label>
                                                    <input type="text" name="zip_code" class="form-control input-lg" value="{{$user->zip_code}}">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input class="form-control" data-toggle="toggle" data-onstyle="success" data-offstyle="danger" data-width="100%" data-on="Yes" data-off="No" type="checkbox" value="1" name="email_verify" {{ $user->email_verify == "1" ? 'checked' : '' }}>
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label>Phone Verification</label>
                                                    <input class="form-control" data-toggle="toggle" data-onstyle="success" data-offstyle="danger" data-width="100%" data-on="Yes" data-off="No" type="checkbox" value="1" name="phone_verify" {{ $user->phone_verify == "1" ? 'checked' : '' }}>
                                                </div>
                                            </div>
                                            <hr/>
